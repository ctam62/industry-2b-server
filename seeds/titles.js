exports.seed = async function (knex) {
  ...
  await knex("titles").insert([
    ...
    { id: 16, service_id: 3, title: "The Sopranos", genres: "Crime, Drama", rank: 6, img: "/images/TheSopranos.jpeg" },    { id: 17, service_id: 1, title: "Stranger Things", genres: "Drama, Fantasy, Horror, Mystery, Sci-Fi, Thriller", rank: 7, img: "/images/strangerthings.jpg" },
